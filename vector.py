...
def md_rag(
    ...
    """
    Creates or update a vector database from MD files in a specified folder. Only adds documents that are not already present in the database.
    ...
    Args:
        ...
        chunk_overlap (int): The number of overlappting characters between chunks.
    """
    ...
    if add_documents:
        ...
        print(
            f"Adding {len(documents)} documents chunk to the vector store...")
        ...
        print(f"Total document chunk in store: {len(existing_ids)}")
